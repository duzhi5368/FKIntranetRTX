...
using FSLib.IPMessager.EventArgs;
...
namespace IPMessagerNet.UI.Controls.Chat.IEView
{
	...
	public class IETabPage : TabPage, IChatService
	{
		...
		public void TaskItemStateChange(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void TaskItemProgressChange(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void AddSendTask(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void AddReceiveTask(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void SendTaskExpires(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void SendTaskStart(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void SendTaskFinish(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void ReceiveTaskFinish(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void ReceiveTaskStart(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
			if (!browser.IsReady())
			{
		...
		public void SendTaskDiscard(FSLib.IPMessager.EventArgs.FileTaskEventArgs e)
		{
