...
namespace FSLib.IPMessager.Network
{
	...
	public class TCPThread : IDisposable
	{
		...
		internal TCPThread(IPMClient client)
		{
			...
			{
				OnNetworkError(new System.EventArgs());
			}
		}
		...
		protected virtual void OnNetworkError(System.EventArgs e)
		{
			...
			{
				if (scpcNetworkError == null) scpcNetworkError = (s) => { NetworkError(this, s as System.EventArgs); };
