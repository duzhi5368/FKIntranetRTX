	...
	public class Host
	{
		...
		public string NickName
		{
			...
			set
			{
				...
				{
					_nickName = value;
					OnInfoChanged(new System.EventArgs());
				}
			}
		}
		...
		public string ClientVersion
		{
			...
			set
			{
				...
				OnClientVersionResolved(new System.EventArgs());
			}
		}
		...
		public byte[] PubKey
		{
			...
			{
				_pubKey = value;
				OnPublicKeyChanged(new System.EventArgs());
			}
		}
		...
		public void ChangeAbsenceMode(bool isInAbsenceMode, string absenceMessage)
		{
			...
			if (this.IsInAbsenceMode != isInAbsenceMode)
			{
				...
				OnAbsenceModeChanged(new System.EventArgs());
			}
			else
			{
				OnAbsenceMessageChanged(new System.EventArgs());
			}
		}
		...
		/// </summary>
		/// <param name="e"></param>
		protected virtual void OnAbsenceModeChanged(System.EventArgs e)
		{
			if (AbsenceModeChanged == null) return;

			if (IPMClient.NeedPostMessage)
			{
				if (_absenceModeChangedCall == null) _absenceModeChangedCall = s => AbsenceModeChanged(this, s as System.EventArgs);
		...
		/// </summary>
		/// <param name="e"></param>
		protected virtual void OnInfoChanged(System.EventArgs e)
		{
			if (NickNameChanged == null) return;

			if (IPMClient.NeedPostMessage)
			{
				if (_nickNameChangedCall == null) _nickNameChangedCall = s => NickNameChanged(this, s as System.EventArgs);
		...
		/// </summary>
		/// <param name="e"></param>
		protected virtual void OnPublicKeyChanged(System.EventArgs e)
		{
			if (PublicKeyChanged == null) return;

			if (IPMClient.NeedPostMessage)
			{
				if (_publicKeyChangedCall == null) _publicKeyChangedCall = s => PublicKeyChanged(this, s as System.EventArgs);
		...
		protected virtual void OnClientVersionResolved(System.EventArgs e)
		{
			if (ClientVersionResolved == null) return;

			if (IPMClient.NeedPostMessage)
			{
				if (_asycnClientVersion == null) _asycnClientVersion = s => ClientVersionResolved(this, s as System.EventArgs);
		...
		protected virtual void OnAbsenceMessageChanged(System.EventArgs e)
		{
			if (AbsenceMessageChanged == null) return;

			if (IPMClient.NeedPostMessage)
			{
				if (_asyncAbsenceMessageChange == null) _asyncAbsenceMessageChange = s => AbsenceMessageChanged(this, s as System.EventArgs);
		...
		protected virtual void OnHostFeatureRefreshed()
		{
			...
			if(IPMClient.NeedPostMessage)
			{
				if (_cbHostFeatureRefreshed == null) _cbHostFeatureRefreshed = s => HostFeatureRefreshed(this, s as System.EventArgs);
				IPMClient.SendSynchronizeMessage(_cbHostFeatureRefreshed, System.EventArgs.Empty);
			}else
			{
				HostFeatureRefreshed(this, System.EventArgs.Empty);
			}
		}
